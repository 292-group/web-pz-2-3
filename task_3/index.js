function drawChess(){
    let container=document.querySelector('.nvv-container');
    let mainBlock=document.querySelector('.nvv-main');
    let letters=document.querySelector('.nvv-letters');
    let block;
    let letter;
    let flag=true;
    ...
    for(let i=0;i<8;i++){
        ...
        block=document.createElement('nvv-div');
   
        if(flag) block.className='nvv-block nvv-black';
   
        else block.className='nvv-block nvv-white';
    ...
    for(let i=1;i<9;i++){
        ...
        block.className='nvv-block nvv-num ';
        block.innerHTML=`${i}`;
